...
console.log('motor instanof Mobil :', motor instanceof Mobil);
...
const anjing1 = new Anjing('Bonbom', 'Guk Guk', 'Pomeranian');
const anjing2 = new Anjing('Roco', 'Woof Woof', 'Shih Tzu');

const kucing1 = new Kucing('Zizi', 'Meong', 'Abu-abu');
const kucing2 = new Kucing('nana', 'Miaw', 'Putih');
